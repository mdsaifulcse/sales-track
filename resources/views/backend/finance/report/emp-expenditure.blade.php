...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active">All Expenditure</li>
    </ol>
@endsection
...
@section('content')
    ...
    <div class="box box-danger">
        ...
        <div class="box-header ui-sortable-handle with-border bg-gray-active">
            ...
            <h3 class="box-title">All Expenditure List</h3>

            <div class="box-tools pull-right">
               {{--<a  href="javascript:void(0)" class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-backdrop="static" data-keyboard="false" title="Add New Expenditure " > <i class="fa fa-plus"></i> Add New</a>--}}
        ...
        <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-lg-2">
                        ...
                        <div class="form-group">
                            {{Form::select('user_id',$users,[],['id'=>'userId','class'=>'form-control','placeholder'=>'All Users'])}}
                        </div>
                    </div>
            ...
            <div class="view_branch_set table-responsive">
                <div class="reg-header pull-right">
                    <button type="button" class="btn btn-success" onclick='exportTableToExcel("allExpenditure", "all_expenditure")'> Download Excel </button>
                </div>

                <div id="allExpenditure" class="">
    ...
    <script>
        ...
        $('#searchData').on('click',function () {
            ...
            $('#data-table').DataTable( {
                ...
                serverSide: true,
                ordering: true,
                ajax: '{{url('/all-expenditure-list?')}}'+'user_id='+user_id+'&purpose='+purpose+'&start_date='+start_date+'&end_date='+end_date,
                columns: [
    ...
    <script>
        $(function() {
            $('#data-table').DataTable( {
                ...
                ajax: '{{ URL::to("all-expenditure-list") }}',
                columns: [
                    { data: 'DT_RowIndex',orderable:false},
                    { data: 'Date'},
                    { data: 'purpose'},
