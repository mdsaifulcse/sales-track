                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input id="mobile_no" type="text" class="form-control{{ $errors->has('contact_mobile') ? ' is-invalid' : '' }}" name="contact_mobile" value="{{ $companyVisit->companyVisitFollowUp->contact_mobile }}" required placeholder="Enter valid mobile">
