                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input id="mobile_no" type="number" class="form-control{{ $errors->has('contact_mobile') ? ' is-invalid' : '' }}" name="contact_mobile" value="{{ old('contact_mobile') }}" required placeholder="Enter valid mobile">
                    ...
                    <div class=" row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{Form::select('status',['1'=>'Follow Up Need','2'=>'No Need Follow Up','3'=>'Need Quotation','4'=>'Quotation Submitted'],[],['id'=>'visitingStatus','class'=>'form-control select','required'=>true,'placeholder'=>'-Select Status-'])}}
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <textarea id="existing_system_details" class="form-control" name="existing_system_details" rows="3" placeholder="Details of their existing system.">{{old('existing_system_details')}}</textarea>
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-10">
                            <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure, Everything is correct? You can\'t edit the information after submit')">
                                {{ __('SUBMIT') }}
                            </button>
                        </div>
                    </div>
