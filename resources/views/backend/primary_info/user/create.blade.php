    ...
    <div class="box box-danger">
        ...
        <div class="box-body">
            <div class="col-md-8 col-md-offset-2" style="margin-top: 20px;">
                <div class="row">
                        {!! Form::open(['route'=>'all-users.store','method'=>'POST','role'=>'form','data-toggle'=>'validator','class'=>'admin-form','files'=>'true'])  !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input id="mobile_no" type="number" class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" name="mobile" value="{{ old('mobile') }}" required placeholder="Mobile must be unique">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="Enter Valid Email">
                    ...
                    <div class=" row">
                        <div class="col-md-4">
                            ...
                            {{Form::select('designation_id',$designations,'',['class'=>'form-control select','required','placeholder'=>'-Select Designation-'])}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{Form::number('salary',$value=old('salary'),['class'=>'form-control'])}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{Form::text('joining_date',$value=old('joining_date'),['class'=>'form-control singleDatePicker','required'=>true])}}
                    ...
                    <div class=" row">
                        <div class="col-md-4">
                            ...
                            {{Form::text('nid',$value=old('nid'),['class'=>'form-control select','placeholder'=>'nid number-'])}}
                            @if ($errors->has('nid'))
                                <span class="help-block">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class=""> Subordinate of <sup class="text-danger">*</sup></label>
                                {{Form::select('subordinate',$superordinate,'',['class'=>'form-control select','required','placeholder'=>'-Select one-'])}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input id="address" type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ old('address') }}" placeholder="Enter Address">
                        ...
                        <div class=" row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="password-confirm" class="col-form-label text-md-right">{{ __('Confirm Password') }} <sup class="text-danger">*</sup></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <label class="slide_upload profile-image" for="file">Photo
                                        <!--  -->
